...
root@ubun-server:~# ip link set ovs0 up
root@ubun-server:~# ip a flush ens38
root@ubun-server:~# ip link set ens38 up
...
root@ubun-server-2:~# ip link set ovs0 up
root@ubun-server-2:~# ip a f ens38
root@ubun-server-2:~# ip link set ens38 up
...
root@ubun-server-2:~# ip link set ovs1 up
root@ubun-server-2:~# ip a f ens39
root@ubun-server-2:~# ip link set ens39 up
```
